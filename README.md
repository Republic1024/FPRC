...
| 发布状态 | 研究软件 v0.1.0；可本地 pip 安装，尚未发布 PyPI，许可证待作者确定 |
...
**开源发布准备**：作者仍需选择许可证、确认数据与复制代码授权、设置公开仓库及正式引用信息。本项目不虚构许可证、论文 DOI、CI 徽章或跨市场验证结果；在许可证确定前，应视为待发布研究软件，而非已经完成授权的开源发行版。
